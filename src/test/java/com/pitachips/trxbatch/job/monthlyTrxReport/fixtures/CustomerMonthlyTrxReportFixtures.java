package com.pitachips.trxbatch.job.monthlyTrxReport.fixtures;
...
public class CustomerMonthlyTrxReportFixtures {
    ...
    public static CustomerMonthlyTrxReport FIXTURE_REPORT_OF_SINGLE_CUSTOMER_WITH_ID_1_THREE_TRXS() {
        ...
        reportOne.setCustomerMonthlyTrxReportDetails(List.of(new CustomerMonthlyTrxReportDetail("acct01",
                                                                                                "ticker01",
                                                                                                ...
                                                                                                "KRW"),
                                                             new CustomerMonthlyTrxReportDetail("acct02",
                                                                                                "ticker02",
                                                                                                transactionDateTimeOne,
                                                                                                ...
                                                                                                "KRW"),
                                                             new CustomerMonthlyTrxReportDetail("acct03",
                                                                                                "ticker03",
                                                                                                transactionDateTimeOne,
                                                                                                TransactionType.BUY,
                                                                                                3000,
    ...
    public static CustomerMonthlyTrxReport FIXTURE_REPORT_OF_SINGLE_CUSTOMER_WITH_ID_2_THREE_TRXS() {
        ...
        reportTwo.setCustomerMonthlyTrxReportDetails(List.of(new CustomerMonthlyTrxReportDetail("acct04",
                                                                                                "ticker04",
                                                                                                ...
                                                                                                BigInteger.valueOf(10000),
                                                                                                "KRW"),
                                                             new CustomerMonthlyTrxReportDetail("acct05",
                                                                                                "ticker05",
                                                                                                transactionDateTimeTwo,
                                                                                                TransactionType.SELL,
                                                                                                2000,
                                                                                                ...
                                                                                                BigInteger.valueOf(40000),
                                                                                                "KRW"),
                                                             new CustomerMonthlyTrxReportDetail("acct06",
                                                                                                "ticker06",
                                                                                                transactionDateTimeTwo,
                                                                                                TransactionType.BUY,
                                                                                                3000,
