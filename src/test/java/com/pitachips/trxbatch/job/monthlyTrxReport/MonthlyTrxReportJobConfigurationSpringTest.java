...
@SpringBootTest
@SpringBatchTest
class MonthlyTrxReportJobConfigurationSpringTest {
    ...
    @Test
    public void monthlyTrxReportJob() throws Exception {
        // given
    ...
    @Test
    public void monthlyTrxReportJobWithoutYearMonth() {
        // given
    ...
    @Test
    public void monthlyTrxReportJobWithEmptyYearMonth() {
        // given
        JobParameters jobParameters =
    ...
    @Test
    public void monthlyTrxReportJobWithInvalidYearMonth() {
        // given
        JobParameters jobParameters =
