...
import com.pitachips.trxbatch.configuration.RestClientConfig;
...
class MonthlyTrxReportBulkEmailServiceSpringTest {
    ...
    public void setUp() {
        RestClient.Builder clientBuilder =
                RestClient.builder().baseUrl("http://localhost:8181").defaultHeader("X-Api-Key", "DUMMY-KEY");
    ...
    public void testRequestBulkReserveSuccess() throws JsonProcessingException {
        ...
        customerTwoData.setMonthlyTrxReportRows(List.of(createSingleRowOfBulkReserveRequestTemplateContent(3),
        ...
        this.server.expect(requestTo("http://localhost:8181/bulk-reserve"))
        ...
        // when
        EmailServerResponse<BulkReserveResponseData> receivedResponse =
    ...
    private static BulkReserveMonthlyTrxReportRequestTemplateContent.MonthlyTrxReportRow createSingleRowOfBulkReserveRequestTemplateContent(
        ...
        row.setTransactionedAt("2023-05-01 00:00:0" + id % 10);
