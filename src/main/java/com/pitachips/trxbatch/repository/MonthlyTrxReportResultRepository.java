...
public class MonthlyTrxReportResultRepository {
    ...
    public int batchInsertSuccessMonthlyTrxReportResult(List<Long> customerIds,
                                                        YearMonth targetYearMonth,
                                                        ReportChannel channel) {

        return trxBatchDsl.insertInto(MONTHLY_TRX_REPORT_RESULT)
                          ...
                          .valuesOfRows(customerIds.stream()
                                                   .map(customerId -> DSL.row(customerId,
                                                                              channel.name(),
    ...
    public int batchInsertFailMonthlyTrxReportResult(List<Long> customerIds,
                                                     YearMonth targetYearMonth,
                                                     ReportChannel channel,
    ...
    public int insertFailMonthlyTrxReportResult(Long customerId,
                                                YearMonth targetYearMonth,
                                                ReportChannel channel,
                                                TrxBatchException failCause) {
