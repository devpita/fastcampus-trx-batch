...
public class HeavyCustomerSeparationItemReader extends AbstractPagingItemReader<Long> {
    ...
    public HeavyCustomerSeparationItemReader(@Value(JOB_PARAM_TARGET_YEAR_MONTH_EXPRESSION) String targetYearMonthString,
    ...
    protected void doReadPage() {
        ...
        List<Long> heavyCustomerIds = monthlyTrxReportRepository.fetchHeavyCustomerIds(from,
                                                                                       before,
